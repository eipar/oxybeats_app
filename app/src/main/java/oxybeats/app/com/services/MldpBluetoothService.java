package oxybeats.app.com.services;
...
public class MldpBluetoothService extends Service {
    ...
    public static final String INTENT_EXTRA_SERVICE_ADDRESS = "BLE_SERVICE_DEVICE_ADDRESS";                         //Keys para la info del Intent
    ...
    public final static String ACTION_BLE_REQ_ENABLE_BT = "oxybeats.app.com.ACTION_BLE_REQ_ENABLE_BT";              //Acciones de los resultados
    public final static String ACTION_BLE_SCAN_RESULT = "oxybeats.app.com.ACTION_BLE_SCAN_RESULT";
    public final static String ACTION_BLE_CONNECTED = "oxybeats.app.com.ACTION_BLE_CONNECTED";
    public final static String ACTION_BLE_DISCONNECTED = "oxybeats.app.com.ACTION_BLE_DISCONNECTED";
    public final static String ACTION_BLE_DATA_RECEIVED = "oxybeats.app.com.ACTION_BLE_DATA_RECEIVED";
    ...
    private BluetoothManager bluetoothManager;       //Se utiliza para obtener una instancia de BluetoothAdapter y hacer el manejo del BLE en gral
    private BluetoothAdapter bluetoothAdapter;       //Se necesita si o si. Representa el propio adaptador de BLE del dispositivos (Bluetooth radio)
    private BluetoothDevice bluetoothDevice;         //Representa un dispositivos remoto de bluetooth
    private BluetoothGatt bluetoothGatt;             //Para tener la funcionalidad de GATT y habilitar la comunicación
    ...
    // Creo el Adapter y Manager necesarios para la comunicación bluetooth
    @Override
    ...
    /** Son los "handler" del BLE **/
    //Maneja primitivas de lo que pasa con la conexión
...
//                bluetoothAdapter.startLeScan(uuidScanList, bleScanCallback);                            //Start scanning with callback method to execute when a new BLE device is found
    ...
    /** writeMLDP está sobrecargada para String y byte **/
    // ----------------------------------------------------------------------------------------------------------------
